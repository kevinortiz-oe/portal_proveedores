...
- **Purchase Order (no_pedido)**: Look in the **"OBSERVACIONES"** section at the bottom. Extract the value labeled as **"OC"** (e.g., "OC VOL-210469" -> `no_pedido`: "VOL-210469").
    - **MULTIPLE OCs (CRITICAL)**: If there are MULTIPLE purchase orders listed (e.g., "OC VOL-208556, VOL-208818, VOL-208640"), you MUST leave `no_pedido` completely blank (null). DO NOT extract anything if there is more than one OC.
